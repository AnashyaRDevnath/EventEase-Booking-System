...
namespace EventEase_Booking.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventID,EventName,ImageURL")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventID,EventName,ImageURL")] Event @event)
        {
            if (id != @event.EventID)
            {
                return NotFound();
